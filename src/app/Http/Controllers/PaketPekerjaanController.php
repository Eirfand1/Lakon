...
class PaketPekerjaanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $paketPekerjaan = PaketPekerjaan::create([
            ...
            'waktu_paket' => $request['waktu_paket'],
            ...
            'nilai_pagu_anggaran' => $request['nilai_pagu_anggaran'],
            'nilai_hps' => $request['nilai_hps'],
            'ppkom_id' => $request['ppkom_id'],
            'daskum_id' => $request['daskum_id'],
            'kode_paket' => $request['kode_paket'],
            'sekolah_id' => $request['sekolah_id']
        ]);

        // Simpan hubungan many-to-many ke tabel pivot (sub_kegiatan_paket)
        foreach ($request['sub_kegiatan_id'] as $subKegiatanId) {
