<x-app-layout>
    <div class="m-4 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-xl">
        ...
        <form action="{{ route('penyedia.permohonan-kontrak.update', $kontrak->kontrak_id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="p-3 bg-blue-50 dark:bg-gray-700/60 rounded-lg">
                            <label class="block text-sm font-semibold text-blue-900 dark:text-blue-300">Nomor
                                Bahpl</label>
                            <input type="number" class="rounded border border-gray-700/30 dark:bg-gray-600"
                                name="nomor_bahpl">
                        </div>

                        <div class="p-3 bg-blue-50 dark:bg-gray-700/60 rounded-lg">
                            <label class="block text-sm font-semibold text-blue-900 dark:text-blue-300">Tanggal
                                Bahpl</label>
                            <input type="date" class="rounded border border-gray-700/30 dark:bg-gray-600"
                                name="tgl_bahpl">
                        </div>
                    </div>
            ...
            <div class="mb-8">
                <div class="flex items-center mb-4 space-x-2 text-gray-600 dark:text-gray-300">
                    <i class="fas fa-cogs fa-lg"></i>
                    <h3 class="font-bold">Ruang Lingkup</h3>
                        ...
                        <template x-for="(input, index) in inputs" :key="index">
                            <div class="flex space-x-2">
                                <input type="text" x-model="input.value" name="ruang_lingkup[]"
                                    class="flex-1 rounded border border-gray-700/30 dark:bg-gray-600 dark:text-gray-200"
                                    placeholder="Masukkan ruang lingkup...">
                                <button type="button" @click="removeInput(index)"
                                    class="px-3 py-1 text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300"
