                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="p-3 bg-blue-50 dark:bg-gray-700/60 rounded-lg">
                            ...
                            <input type="number" class="rounded border border-gray-700/30 dark:bg-gray-600" name="nomor_bahpl"> 
                        </div>

                        <div class="p-3 bg-blue-50 dark:bg-gray-700/60 rounded-lg">
                            <label class="block text-sm font-semibold text-blue-900 dark:text-blue-300">Tanggal Bahpl</label>
                            <input type="date" class="rounded border border-gray-700/30 dark:bg-gray-600" name="tgl_bahpl">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="p-3 bg-blue-50 dark:bg-gray-700/60 rounded-lg">
                            ...
                            <input type="number" class="rounded border border-gray-700/30 dark:bg-gray-600" name="nomor_dppl"> 
                        </div>

                        <div class="p-3 bg-blue-50 dark:bg-gray-700/60 rounded-lg">
                            <label class="block text-sm font-semibold text-blue-900 dark:text-blue-300">Tanggal dppl</label>
                            <input type="date" class="rounded border border-gray-700/30 dark:bg-gray-600" name="tgl_dppl">
                        </div>
                    </div>
                </div>
            </div>
