        ...
        function subKegiatanManager(options) {
            return {
                ...
                removeInput(index) {
                    ...
                    if (this.$wire && this.$wire.sub_kegiatan) {
                        this.$wire.sub_kegiatan.splice(index, 1);
                    }
                },
                ...
                selectOption(index, option) {
                    ...
                    if (this.$wire && this.$wire.sub_kegiatan) {
                        this.$wire.sub_kegiatan[index] = option.sub_kegiatan_id;
                    }
                }
            }
        }
        ...
        function daskumManager(options) {
            ...
            return {
                ...
                selectOption(option) {
                    ...
                    if (this.$wire) {
                        this.$wire.set('daskum_id', option.daskum_id);
                    }
                }
            }
        }
        ...
        function sekolahManager(options) {
            ...
            return {
                ...
                selectOption(option) {
                    ...
                    if (this.$wire) {
                        this.$wire.set('sekolah_id', option.sekolah_id);
                    }
                }
            }
        }
