<div class="overflow-x-auto pb-5" id="tindakan">
    ...
    <table class="table">
        <thead class="text-gray-600  dark:text-gray-300">
            <tr>
                ...
                <th class="text-center border border-gray-400/30">Keterangan Tindakan</th>
        ...
        <tbody>
            <tr>
                ...
                <input type="hidden" name="keterangan_id" id="keteranganIdTindakan">
                ...
                <td class="text-center border border-gray-400/30">
                    <input class="w-full dark:bg-gray-800 rounded" type="text" name="keterangan" id="keteranganTindakan">
                </td>
                ...
                @foreach($keterangan_tindakan as $row)
                    <tr>
                        ...
                        <td class="border border-gray-400/30">
                            <div class="flex gap-1">
                                <label class="btn btn-warning btn-sm text-gray-100" onclick="editKeteranganTindakan({{ $row }})">
                                    <i class="fa fa-edit"></i>
                                </label>
                                <label class="btn btn-error btn-sm text-gray-100" for="delete-modal" onclick="deleteKeteranganTindakan({{ $row->keterangan_id }})">
...
<script>
    ...
    function editKeteranganTindakan(row) {
        document.getElementById('keteranganIdTindakan').value = row.keterangan_id;
        document.getElementById('keteranganTindakan').value = row.keterangan;
    }

    function deleteKeteranganTindakan(id) {
