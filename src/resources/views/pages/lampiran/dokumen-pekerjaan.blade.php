<div class="overflow-x-auto pb-5" id="pekerjaan">
    ...
    <table class="table">
        <thead class="text-gray-600  dark:text-gray-300">
            <tr>
                ...
                <th class="text-center border border-gray-400/30">Keterangan Lingkup Pekerjaan</th>
        ...
        <tbody>
            <tr>
                ...
                <input type="hidden" name="dokumen_id" id="dokumenIdPekerjaan">
                ...
                <td class="text-center border border-gray-400/30">
                    <input class="w-full dark:bg-gray-800 rounded" type="text" name="keterangan" id="keteranganPekerjaan">
                </td>
                ...
                @foreach($dokumen_pekerjaan as $row)
                    <tr>
                        ...
                        <td class="border border-gray-400/30">
                            <div class="flex gap-1">
                                <label class="btn btn-warning btn-sm text-gray-100" onclick="editDokumenPekerjaan({{ $row }})">
                                    <i class="fa fa-edit"></i>
                                </label>
                                <label class="btn btn-error btn-sm text-gray-100" for="delete-modal" onclick="deleteDokumenPekerjaan({{ $row->dokumen_id }})">
...
<script>
    ...
    function editDokumenPekerjaan(row) {
        document.getElementById('dokumenIdPekerjaan').value = row.dokumen_id;
        document.getElementById('keteranganPekerjaan').value = row.keterangan;
    }

    function deleteDokumenPekerjaan(id) {
