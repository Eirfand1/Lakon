<div class="overflow-x-auto pb-5" id="tambahan">
    ...
    <table class="table">
        <thead class="text-gray-600  dark:text-gray-300">
            <tr>
                ...
                <th class="text-center border border-gray-400/30">Keterangan Ketentuan Pembayaran</th>
        ...
        <tbody>
            <tr>
                ...
                <input type="hidden" name="dokumen_id" id="dokumenIdTambahan">
                ...
                <td class="text-center border border-gray-400/30">
                    <input class="w-full dark:bg-gray-800 rounded" type="text" name="keterangan" id="keteranganTambahan">
                </td>
                ...
                @foreach($dokumen_tambahan as $row)
                    <tr>
                        ...
                        <td class="border border-gray-400/30">
                            <div class="flex gap-1">
                                <label class="btn btn-warning btn-sm text-gray-100" onclick="editDokumenTambahan({{ $row }})">
                                    <i class="fa fa-edit"></i>
                                </label>
                                <label class="btn btn-error btn-sm text-gray-100" for="delete-modal" onclick="deleteDokumenTambahan({{ $row->dokumen_id }})">
...
<script>
    ...
    function editDokumenTambahan(row) {
        document.getElementById('dokumenIdTambahan').value = row.dokumen_id;
        document.getElementById('keteranganTambahan').value = row.keterangan;
    }

    function deleteDokumenTambahan(id) {
